...
public class BindingUtils {
    ...
    public static int getDisplayWidthDp() {
        return BindingUtils.px2dip(getDisplayWidth());
    }

    public static Object getValueFromObservable(Observable observable , String key) {
        Map<String , Object> valueMap = ((ObservableField<Map<String,Object>>) observable).get();
