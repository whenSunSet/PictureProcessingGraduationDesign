...
public class PictureFilterItemManagerVM extends BaseItemManagerVM<PictureFilterItemManagerVM.PictureFilter> {
    ...
    public static class PictureFilter extends BaseItemVM {
        public final ObservableField<String> mImageUri=new ObservableField<>();
        public final Integer mPosition;
        public PictureFilter(ObservableField<? super Object> clickedItemListener , String imageUri , Integer position) {
